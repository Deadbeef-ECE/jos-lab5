...
libmain(int argc, char **argv)
{
  ...
  800052:	e8 2c 01 00 00       	call   800183 <sys_getenvid>
...
exit(void)
{
  ...
  800093:	83 ec 18             	sub    $0x18,%esp
	close_all();
  800096:	e8 78 06 00 00       	call   800713 <close_all>
	sys_env_destroy(0);
  80009b:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a2:	e8 76 00 00 00       	call   80011d <sys_env_destroy>
}
  8000a7:	c9                   	leave  
  8000a8:	c3                   	ret    
  8000a9:	66 90                	xchg   %ax,%ax
  8000ab:	90                   	nop
...
sys_cgetc(void)
{
  ...
  800110:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800113:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800116:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_env_destroy(envid_t envid)
{
  ...
  800120:	83 ec 38             	sub    $0x38,%esp
  800123:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800126:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800129:	89 7d fc             	mov    %edi,-0x4(%ebp)
  ...
  80014c:	7e 28                	jle    800176 <sys_env_destroy+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  80014e:	89 44 24 10          	mov    %eax,0x10(%esp)
  800152:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  800159:	00 
  80015a:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800161:	00 
  800162:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800169:	00 
  80016a:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800171:	e8 9a 0b 00 00       	call   800d10 <_panic>
...
sys_getenvid(void)
{
  ...
  800189:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80018c:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80018f:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
sys_yield(void)
{
  ...
  8001cb:	b8 01 00 00 00       	mov    $0x1,%eax
  8001d0:	0f a2                	cpuid  
...
sys_yield(void)
{
  ...
  8001e8:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8001eb:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8001ee:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8001f1:	89 ec                	mov    %ebp,%esp
  8001f3:	5d                   	pop    %ebp
  8001f4:	c3                   	ret    
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001f8:	83 ec 38             	sub    $0x38,%esp
  8001fb:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001fe:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800201:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800204:	b8 01 00 00 00       	mov    $0x1,%eax
  800209:	0f a2                	cpuid  
  ...
  800226:	7e 28                	jle    800250 <sys_page_alloc+0x5b>
		panic("syscall %d returned %d (> 0)", num, ret);
  800228:	89 44 24 10          	mov    %eax,0x10(%esp)
  80022c:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800233:	00 
  800234:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  80023b:	00 
  80023c:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800243:	00 
  800244:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  80024b:	e8 c0 0a 00 00       	call   800d10 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800250:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800253:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800256:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800259:	89 ec                	mov    %ebp,%esp
  80025b:	5d                   	pop    %ebp
  80025c:	c3                   	ret    

0080025d <sys_page_map>:
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800260:	83 ec 38             	sub    $0x38,%esp
  800263:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800266:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800269:	89 7d fc             	mov    %edi,-0x4(%ebp)
  80026c:	b8 01 00 00 00       	mov    $0x1,%eax
  800271:	0f a2                	cpuid  
  800273:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  800275:	b8 05 00 00 00       	mov    $0x5,%eax
  80027a:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80027d:	8b 55 08             	mov    0x8(%ebp),%edx
  800280:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800283:	8b 7d 14             	mov    0x14(%ebp),%edi
  800286:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  80028d:	7e 28                	jle    8002b7 <sys_page_map+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80028f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800293:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80029a:	00 
  80029b:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8002a2:	00 
  8002a3:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8002aa:	00 
  8002ab:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8002b2:	e8 59 0a 00 00       	call   800d10 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002b7:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002ba:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002bd:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002c0:	89 ec                	mov    %ebp,%esp
  8002c2:	5d                   	pop    %ebp
  8002c3:	c3                   	ret    

008002c4 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002c7:	83 ec 38             	sub    $0x38,%esp
  8002ca:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002cd:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002d0:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8002d3:	b8 01 00 00 00       	mov    $0x1,%eax
  8002d8:	0f a2                	cpuid  
  ...
  8002e1:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8002f4:	7e 28                	jle    80031e <sys_page_unmap+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002f6:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002fa:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800301:	00 
  800302:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800309:	00 
  80030a:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800311:	00 
  800312:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800319:	e8 f2 09 00 00       	call   800d10 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  80031e:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800321:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800324:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800327:	89 ec                	mov    %ebp,%esp
  800329:	5d                   	pop    %ebp
  80032a:	c3                   	ret    

0080032b <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  80032e:	83 ec 38             	sub    $0x38,%esp
  800331:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800334:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800337:	89 7d fc             	mov    %edi,-0x4(%ebp)
  ...
  800348:	b8 08 00 00 00       	mov    $0x8,%eax
  ...
  80035b:	7e 28                	jle    800385 <sys_env_set_status+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80035d:	89 44 24 10          	mov    %eax,0x10(%esp)
  800361:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  800368:	00 
  800369:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800370:	00 
  800371:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800378:	00 
  800379:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800380:	e8 8b 09 00 00       	call   800d10 <_panic>
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800385:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800388:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80038b:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80038e:	89 ec                	mov    %ebp,%esp
  800390:	5d                   	pop    %ebp
  800391:	c3                   	ret    

00800392 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800395:	83 ec 38             	sub    $0x38,%esp
  800398:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80039b:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80039e:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8003a1:	b8 01 00 00 00       	mov    $0x1,%eax
  8003a6:	0f a2                	cpuid  
  ...
  8003af:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8003c2:	7e 28                	jle    8003ec <sys_env_set_trapframe+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003c4:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003c8:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003cf:	00 
  8003d0:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8003d7:	00 
  8003d8:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8003df:	00 
  8003e0:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8003e7:	e8 24 09 00 00       	call   800d10 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800416:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  800429:	7e 28                	jle    800453 <sys_env_set_pgfault_upcall+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80042b:	89 44 24 10          	mov    %eax,0x10(%esp)
  80042f:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  800436:	00 
  800437:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  80043e:	00 
  80043f:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800446:	00 
  800447:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  80044e:	e8 bd 08 00 00       	call   800d10 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80046f:	b8 01 00 00 00       	mov    $0x1,%eax
  800474:	0f a2                	cpuid  
  800476:	89 d6                	mov    %edx,%esi
	...
	asm volatile("int %1\n"
  800478:	be 00 00 00 00       	mov    $0x0,%esi
  80047d:	b8 0c 00 00 00       	mov    $0xc,%eax
  800482:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800485:	8b 55 08             	mov    0x8(%ebp),%edx
  800488:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80048b:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800490:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800493:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800496:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800499:	89 ec                	mov    %ebp,%esp
  80049b:	5d                   	pop    %ebp
  80049c:	c3                   	ret    

0080049d <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8004a0:	83 ec 38             	sub    $0x38,%esp
  8004a3:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8004a6:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8004a9:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8004ac:	b8 01 00 00 00       	mov    $0x1,%eax
  8004b1:	0f a2                	cpuid  
  8004b3:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8004cc:	7e 28                	jle    8004f6 <sys_ipc_recv+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004ce:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004d2:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8004d9:	00 
  8004da:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8004e1:	00 
  8004e2:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8004e9:	00 
  8004ea:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8004f1:	e8 1a 08 00 00       	call   800d10 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8004f6:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004f9:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8004fc:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8004ff:	89 ec                	mov    %ebp,%esp
  800501:	5d                   	pop    %ebp
  800502:	c3                   	ret    
  800503:	66 90                	xchg   %ax,%ax
  800505:	66 90                	xchg   %ax,%ax
  800507:	66 90                	xchg   %ax,%ax
  800509:	66 90                	xchg   %ax,%ax
  80050b:	66 90                	xchg   %ax,%ax
  80050d:	66 90                	xchg   %ax,%ax
  80050f:	90                   	nop
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  800637:	c7 04 24 b8 1c 80 00 	movl   $0x801cb8,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006ce:	e8 f1 fb ff ff       	call   8002c4 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007d7:	e8 81 fa ff ff       	call   80025d <sys_page_map>
  ...
  800812:	e8 46 fa ff ff       	call   80025d <sys_page_map>
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8008a8:	c7 04 24 f9 1c 80 00 	movl   $0x801cf9,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80098a:	c7 04 24 15 1d 80 00 	movl   $0x801d15,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800a41:	c7 04 24 d8 1c 80 00 	movl   $0x801cd8,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c51:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800c54:	c7 44 24 08 32 1d 80 	movl   $0x801d32,0x8(%esp)
  800c5b:	00 
  800c5c:	c7 44 24 04 77 00 00 	movl   $0x77,0x4(%esp)
  800c63:	00 
  800c64:	c7 04 24 50 1d 80 00 	movl   $0x801d50,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c76:	c7 44 24 08 5b 1d 80 	movl   $0x801d5b,0x8(%esp)
  800c7d:	00 
  800c7e:	c7 44 24 04 67 00 00 	movl   $0x67,0x4(%esp)
  800c85:	00 
  800c86:	c7 04 24 50 1d 80 00 	movl   $0x801d50,(%esp)
...
open(const char *path, int mode)
{
  ...
  800c98:	c7 44 24 08 78 1d 80 	movl   $0x801d78,0x8(%esp)
  800c9f:	00 
  800ca0:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  800ca7:	00 
  800ca8:	c7 04 24 50 1d 80 00 	movl   $0x801d50,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d21:	e8 5d f4 ff ff       	call   800183 <sys_getenvid>
  ...
  800d3c:	c7 04 24 90 1d 80 00 	movl   $0x801d90,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800d95:	e8 12 f3 ff ff       	call   8000ac <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800dfe:	e8 a9 f2 ff ff       	call   8000ac <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800f0c:	0f be 80 b3 1d 80 00 	movsbl 0x801db3(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801108:	c7 44 24 08 cb 1d 80 	movl   $0x801dcb,0x8(%esp)
  80110f:	00 
  ...
  801128:	c7 44 24 08 d4 1d 80 	movl   $0x801dd4,0x8(%esp)
  80112f:	00 
  ...
  80115a:	b8 c4 1d 80 00       	mov    $0x801dc4,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8018ab:	e8 ed eb ff ff       	call   80049d <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801926:	e8 e5 f3 ff ff       	call   800d10 <_panic>
		sys_yield();
  80192b:	e8 8c e8 ff ff       	call   8001bc <sys_yield>
	// LAB 4: Your code here.
	int r;
  ...
  801942:	e8 19 eb ff ff       	call   800460 <sys_ipc_try_send>

...
libmain(int argc, char **argv)
{
  ...
  800066:	e8 2c 01 00 00       	call   800197 <sys_getenvid>
...
exit(void)
{
  ...
  8000a7:	83 ec 18             	sub    $0x18,%esp
	close_all();
  8000aa:	e8 74 06 00 00       	call   800723 <close_all>
	sys_env_destroy(0);
  8000af:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000b6:	e8 76 00 00 00       	call   800131 <sys_env_destroy>
}
  8000bb:	c9                   	leave  
  8000bc:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000eb:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8000ee:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8000f1:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_cgetc(void)
{
  ...
  8000fe:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800101:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800104:	89 7d fc             	mov    %edi,-0x4(%ebp)
...
sys_cgetc(void)
{
  ...
  800124:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800127:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80012a:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_env_destroy(envid_t envid)
{
  ...
  800134:	83 ec 38             	sub    $0x38,%esp
  800137:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80013a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80013d:	89 7d fc             	mov    %edi,-0x4(%ebp)
  ...
  80014e:	b8 03 00 00 00       	mov    $0x3,%eax
  ...
  800160:	7e 28                	jle    80018a <sys_env_destroy+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  800162:	89 44 24 10          	mov    %eax,0x10(%esp)
  800166:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80016d:	00 
  80016e:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  800175:	00 
  800176:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80017d:	00 
  80017e:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  800185:	e8 96 0b 00 00       	call   800d20 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80018a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80018d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800190:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_getenvid(void)
{
  ...
  80019d:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8001a0:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8001a3:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8001a6:	b8 01 00 00 00       	mov    $0x1,%eax
  8001ab:	0f a2                	cpuid  
...
sys_yield(void)
{
  ...
  8001df:	b8 01 00 00 00       	mov    $0x1,%eax
  8001e4:	0f a2                	cpuid  
  ...
  8001ed:	b8 0b 00 00 00       	mov    $0xb,%eax
  8001f2:	89 d1                	mov    %edx,%ecx
  8001f4:	89 d3                	mov    %edx,%ebx
...
sys_yield(void)
{
  ...
  8001fc:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8001ff:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800202:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800205:	89 ec                	mov    %ebp,%esp
  800207:	5d                   	pop    %ebp
  800208:	c3                   	ret    

00800209 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  80020c:	83 ec 38             	sub    $0x38,%esp
  80020f:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800212:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800215:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800218:	b8 01 00 00 00       	mov    $0x1,%eax
  80021d:	0f a2                	cpuid  
  ...
  800226:	b8 04 00 00 00       	mov    $0x4,%eax
  80022b:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  80022e:	8b 55 08             	mov    0x8(%ebp),%edx
  800231:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800234:	89 f7                	mov    %esi,%edi
  ...
  80023a:	7e 28                	jle    800264 <sys_page_alloc+0x5b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80023c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800240:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800247:	00 
  800248:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  80024f:	00 
  800250:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800257:	00 
  800258:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  80025f:	e8 bc 0a 00 00       	call   800d20 <_panic>
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800264:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800267:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80026a:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80026d:	89 ec                	mov    %ebp,%esp
  80026f:	5d                   	pop    %ebp
  800270:	c3                   	ret    
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800274:	83 ec 38             	sub    $0x38,%esp
  800277:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80027a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80027d:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800280:	b8 01 00 00 00       	mov    $0x1,%eax
  800285:	0f a2                	cpuid  
  800287:	89 d6                	mov    %edx,%esi
	...
	asm volatile("int %1\n"
  800289:	b8 05 00 00 00       	mov    $0x5,%eax
  80028e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800291:	8b 55 08             	mov    0x8(%ebp),%edx
  800294:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800297:	8b 7d 14             	mov    0x14(%ebp),%edi
  80029a:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  8002a1:	7e 28                	jle    8002cb <sys_page_map+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002a3:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002a7:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  8002ae:	00 
  8002af:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  8002b6:	00 
  8002b7:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8002be:	00 
  8002bf:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  8002c6:	e8 55 0a 00 00       	call   800d20 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002cb:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002ce:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002d1:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8002d4:	89 ec                	mov    %ebp,%esp
  8002d6:	5d                   	pop    %ebp
  8002d7:	c3                   	ret    

008002d8 <sys_page_unmap>:
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002db:	83 ec 38             	sub    $0x38,%esp
  8002de:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8002e1:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8002e4:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8002e7:	b8 01 00 00 00       	mov    $0x1,%eax
  8002ec:	0f a2                	cpuid  
  ...
  8002f5:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  800308:	7e 28                	jle    800332 <sys_page_unmap+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80030a:	89 44 24 10          	mov    %eax,0x10(%esp)
  80030e:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800315:	00 
  800316:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  80031d:	00 
  80031e:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800325:	00 
  800326:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  80032d:	e8 ee 09 00 00       	call   800d20 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800332:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800335:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800338:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80033b:	89 ec                	mov    %ebp,%esp
  80033d:	5d                   	pop    %ebp
  80033e:	c3                   	ret    

0080033f <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800342:	83 ec 38             	sub    $0x38,%esp
  800345:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800348:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80034b:	89 7d fc             	mov    %edi,-0x4(%ebp)
  80034e:	b8 01 00 00 00       	mov    $0x1,%eax
  800353:	0f a2                	cpuid  
  ...
  80036f:	7e 28                	jle    800399 <sys_env_set_status+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800371:	89 44 24 10          	mov    %eax,0x10(%esp)
  800375:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80037c:	00 
  80037d:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  800384:	00 
  800385:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80038c:	00 
  80038d:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  800394:	e8 87 09 00 00       	call   800d20 <_panic>
...
008003a6 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8003d6:	7e 28                	jle    800400 <sys_env_set_trapframe+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003d8:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003dc:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003e3:	00 
  8003e4:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  8003eb:	00 
  8003ec:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8003f3:	00 
  8003f4:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  8003fb:	e8 20 09 00 00       	call   800d20 <_panic>
...
0080040d <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80041c:	b8 01 00 00 00       	mov    $0x1,%eax
  800421:	0f a2                	cpuid  
  ...
  80042a:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80043d:	7e 28                	jle    800467 <sys_env_set_pgfault_upcall+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80043f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800443:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80044a:	00 
  80044b:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  800452:	00 
  800453:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80045a:	00 
  80045b:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  800462:	e8 b9 08 00 00       	call   800d20 <_panic>
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80047a:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80047d:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800480:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800483:	b8 01 00 00 00       	mov    $0x1,%eax
  800488:	0f a2                	cpuid  
  80048a:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  80048c:	be 00 00 00 00       	mov    $0x0,%esi
  800491:	b8 0c 00 00 00       	mov    $0xc,%eax
  800496:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800499:	8b 55 08             	mov    0x8(%ebp),%edx
  80049c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80049f:	8b 7d 14             	mov    0x14(%ebp),%edi
...
sys_ipc_recv(void *dstva)
{
  ...
  8004b4:	83 ec 38             	sub    $0x38,%esp
  8004b7:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  8004ba:	89 75 f8             	mov    %esi,-0x8(%ebp)
  8004bd:	89 7d fc             	mov    %edi,-0x4(%ebp)
  8004c0:	b8 01 00 00 00       	mov    $0x1,%eax
  8004c5:	0f a2                	cpuid  
  ...
  8004e0:	7e 28                	jle    80050a <sys_ipc_recv+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004e2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004e6:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8004ed:	00 
  8004ee:	c7 44 24 08 b8 1c 80 	movl   $0x801cb8,0x8(%esp)
  8004f5:	00 
  8004f6:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8004fd:	00 
  8004fe:	c7 04 24 d5 1c 80 00 	movl   $0x801cd5,(%esp)
  800505:	e8 16 08 00 00       	call   800d20 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  80050a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80050d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800510:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  80061e:	39 05 08 30 80 00    	cmp    %eax,0x803008
  800624:	75 10                	jne    800636 <dev_lookup+0x21>
			*dev = devtab[i];
  800626:	8b 45 0c             	mov    0xc(%ebp),%eax
  800629:	c7 00 08 30 80 00    	movl   $0x803008,(%eax)
			return 0;
  ...
  800647:	c7 04 24 e4 1c 80 00 	movl   $0x801ce4,(%esp)
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006de:	e8 f5 fb ff ff       	call   8002d8 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007e7:	e8 85 fa ff ff       	call   800271 <sys_page_map>
  ...
  800822:	e8 4a fa ff ff       	call   800271 <sys_page_map>
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8008b8:	c7 04 24 25 1d 80 00 	movl   $0x801d25,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  80099a:	c7 04 24 41 1d 80 00 	movl   $0x801d41,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  800a51:	c7 04 24 04 1d 80 00 	movl   $0x801d04,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  800c61:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  800c64:	c7 44 24 08 5e 1d 80 	movl   $0x801d5e,0x8(%esp)
  800c6b:	00 
  800c6c:	c7 44 24 04 77 00 00 	movl   $0x77,0x4(%esp)
  800c73:	00 
  800c74:	c7 04 24 7c 1d 80 00 	movl   $0x801d7c,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  800c86:	c7 44 24 08 87 1d 80 	movl   $0x801d87,0x8(%esp)
  800c8d:	00 
  800c8e:	c7 44 24 04 67 00 00 	movl   $0x67,0x4(%esp)
  800c95:	00 
  800c96:	c7 04 24 7c 1d 80 00 	movl   $0x801d7c,(%esp)
...
open(const char *path, int mode)
{
  ...
  800ca8:	c7 44 24 08 a4 1d 80 	movl   $0x801da4,0x8(%esp)
  800caf:	00 
  800cb0:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  800cb7:	00 
  800cb8:	c7 04 24 7c 1d 80 00 	movl   $0x801d7c,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d2b:	8b 35 04 30 80 00    	mov    0x803004,%esi
  800d31:	e8 61 f4 ff ff       	call   800197 <sys_getenvid>
  ...
  800d4c:	c7 04 24 bc 1d 80 00 	movl   $0x801dbc,(%esp)
  ...
  800d62:	e8 53 00 00 00       	call   800dba <vcprintf>
	cprintf("\n");
  800d67:	c7 04 24 ac 1c 80 00 	movl   $0x801cac,(%esp)
...
putch(int ch, struct printbuf *b)
{
  ...
  800da5:	e8 16 f3 ff ff       	call   8000c0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800e0e:	e8 ad f2 ff ff       	call   8000c0 <sys_cputs>
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800f1c:	0f be 80 df 1d 80 00 	movsbl 0x801ddf(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  801118:	c7 44 24 08 f7 1d 80 	movl   $0x801df7,0x8(%esp)
  80111f:	00 
  ...
  801138:	c7 44 24 08 00 1e 80 	movl   $0x801e00,0x8(%esp)
  80113f:	00 
  ...
  80116a:	b8 f0 1d 80 00       	mov    $0x801df0,%eax
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8018bb:	e8 f1 eb ff ff       	call   8004b1 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801936:	e8 e5 f3 ff ff       	call   800d20 <_panic>
		sys_yield();
  80193b:	e8 90 e8 ff ff       	call   8001d0 <sys_yield>
	// LAB 4: Your code here.
	int r;
  ...
  801952:	e8 1d eb ff ff       	call   800474 <sys_ipc_try_send>

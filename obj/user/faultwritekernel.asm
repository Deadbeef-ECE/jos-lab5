...
libmain(int argc, char **argv)
{
  ...
  800056:	e8 2c 01 00 00       	call   800187 <sys_getenvid>
...
exit(void)
{
  ...
  800097:	83 ec 18             	sub    $0x18,%esp
	close_all();
  80009a:	e8 74 06 00 00       	call   800713 <close_all>
	sys_env_destroy(0);
  80009f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8000a6:	e8 76 00 00 00       	call   800121 <sys_env_destroy>
}
  8000ab:	c9                   	leave  
  8000ac:	c3                   	ret    
...
sys_cputs(const char *s, size_t len)
{
  ...
  8000db:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8000de:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8000e1:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_cgetc(void)
{
  ...
  800114:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800117:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80011a:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80011d:	89 ec                	mov    %ebp,%esp
  80011f:	5d                   	pop    %ebp
  800120:	c3                   	ret    

00800121 <sys_env_destroy>:
...
sys_env_destroy(envid_t envid)
{
  ...
  800124:	83 ec 38             	sub    $0x38,%esp
  800127:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80012a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80012d:	89 7d fc             	mov    %edi,-0x4(%ebp)
  ...
  800148:	89 cf                	mov    %ecx,%edi
  80014a:	89 ce                	mov    %ecx,%esi
  ...
  800150:	7e 28                	jle    80017a <sys_env_destroy+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  800152:	89 44 24 10          	mov    %eax,0x10(%esp)
  800156:	c7 44 24 0c 03 00 00 	movl   $0x3,0xc(%esp)
  80015d:	00 
  80015e:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800165:	00 
  800166:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80016d:	00 
  80016e:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800175:	e8 96 0b 00 00       	call   800d10 <_panic>
...
sys_env_destroy(envid_t envid)
{
  ...
  80017a:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80017d:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800180:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_getenvid(void)
{
  ...
  80018d:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800190:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800193:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800196:	b8 01 00 00 00       	mov    $0x1,%eax
  80019b:	0f a2                	cpuid  
...
sys_yield(void)
{
  ...
  8001cf:	b8 01 00 00 00       	mov    $0x1,%eax
  8001d4:	0f a2                	cpuid  
...
sys_yield(void)
{
  ...
  8001ec:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8001ef:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8001f2:	8b 7d fc             	mov    -0x4(%ebp),%edi
  8001f5:	89 ec                	mov    %ebp,%esp
  8001f7:	5d                   	pop    %ebp
  8001f8:	c3                   	ret    

008001f9 <sys_page_alloc>:
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  8001fc:	83 ec 38             	sub    $0x38,%esp
  8001ff:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800202:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800205:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800208:	b8 01 00 00 00       	mov    $0x1,%eax
  80020d:	0f a2                	cpuid  
  ...
  80022a:	7e 28                	jle    800254 <sys_page_alloc+0x5b>
		panic("syscall %d returned %d (> 0)", num, ret);
  80022c:	89 44 24 10          	mov    %eax,0x10(%esp)
  800230:	c7 44 24 0c 04 00 00 	movl   $0x4,0xc(%esp)
  800237:	00 
  800238:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  80023f:	00 
  800240:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800247:	00 
  800248:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  80024f:	e8 bc 0a 00 00       	call   800d10 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800264:	83 ec 38             	sub    $0x38,%esp
  800267:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80026a:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80026d:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800270:	b8 01 00 00 00       	mov    $0x1,%eax
  800275:	0f a2                	cpuid  
  800277:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  800279:	b8 05 00 00 00       	mov    $0x5,%eax
  80027e:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800281:	8b 55 08             	mov    0x8(%ebp),%edx
  800284:	8b 5d 10             	mov    0x10(%ebp),%ebx
  800287:	8b 7d 14             	mov    0x14(%ebp),%edi
  80028a:	8b 75 18             	mov    0x18(%ebp),%esi
  ...
  800291:	7e 28                	jle    8002bb <sys_page_map+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800293:	89 44 24 10          	mov    %eax,0x10(%esp)
  800297:	c7 44 24 0c 05 00 00 	movl   $0x5,0xc(%esp)
  80029e:	00 
  80029f:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8002a6:	00 
  8002a7:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8002ae:	00 
  8002af:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8002b6:	e8 55 0a 00 00       	call   800d10 <_panic>
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8002bb:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8002be:	8b 75 f8             	mov    -0x8(%ebp),%esi
  8002c1:	8b 7d fc             	mov    -0x4(%ebp),%edi
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  8002d7:	b8 01 00 00 00       	mov    $0x1,%eax
  8002dc:	0f a2                	cpuid  
  ...
  8002e5:	b8 06 00 00 00       	mov    $0x6,%eax
  ...
  8002f8:	7e 28                	jle    800322 <sys_page_unmap+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8002fa:	89 44 24 10          	mov    %eax,0x10(%esp)
  8002fe:	c7 44 24 0c 06 00 00 	movl   $0x6,0xc(%esp)
  800305:	00 
  800306:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  80030d:	00 
  80030e:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800315:	00 
  800316:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  80031d:	e8 ee 09 00 00       	call   800d10 <_panic>
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800322:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800325:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800328:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80032b:	89 ec                	mov    %ebp,%esp
  80032d:	5d                   	pop    %ebp
  80032e:	c3                   	ret    

0080032f <sys_env_set_status>:
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800332:	83 ec 38             	sub    $0x38,%esp
  800335:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  800338:	89 75 f8             	mov    %esi,-0x8(%ebp)
  80033b:	89 7d fc             	mov    %edi,-0x4(%ebp)
  80033e:	b8 01 00 00 00       	mov    $0x1,%eax
  800343:	0f a2                	cpuid  
  800345:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  80035f:	7e 28                	jle    800389 <sys_env_set_status+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  800361:	89 44 24 10          	mov    %eax,0x10(%esp)
  800365:	c7 44 24 0c 08 00 00 	movl   $0x8,0xc(%esp)
  80036c:	00 
  80036d:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800374:	00 
  800375:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80037c:	00 
  80037d:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800384:	e8 87 09 00 00       	call   800d10 <_panic>
...
00800396 <sys_env_set_trapframe>:
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  8003b3:	b8 09 00 00 00       	mov    $0x9,%eax
  ...
  8003c6:	7e 28                	jle    8003f0 <sys_env_set_trapframe+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  8003c8:	89 44 24 10          	mov    %eax,0x10(%esp)
  8003cc:	c7 44 24 0c 09 00 00 	movl   $0x9,0xc(%esp)
  8003d3:	00 
  8003d4:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8003db:	00 
  8003dc:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8003e3:	00 
  8003e4:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8003eb:	e8 20 09 00 00       	call   800d10 <_panic>
...
008003fd <sys_env_set_pgfault_upcall>:
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  80041a:	b8 0a 00 00 00       	mov    $0xa,%eax
  ...
  80042d:	7e 28                	jle    800457 <sys_env_set_pgfault_upcall+0x5a>
		panic("syscall %d returned %d (> 0)", num, ret);
  80042f:	89 44 24 10          	mov    %eax,0x10(%esp)
  800433:	c7 44 24 0c 0a 00 00 	movl   $0xa,0xc(%esp)
  80043a:	00 
  80043b:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  800442:	00 
  800443:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80044a:	00 
  80044b:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  800452:	e8 b9 08 00 00       	call   800d10 <_panic>
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800457:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  80045a:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80045d:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800460:	89 ec                	mov    %ebp,%esp
  800462:	5d                   	pop    %ebp
  800463:	c3                   	ret    

00800464 <sys_ipc_try_send>:
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  80046a:	89 5d f4             	mov    %ebx,-0xc(%ebp)
  80046d:	89 75 f8             	mov    %esi,-0x8(%ebp)
  800470:	89 7d fc             	mov    %edi,-0x4(%ebp)
  800473:	b8 01 00 00 00       	mov    $0x1,%eax
  800478:	0f a2                	cpuid  
  80047a:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
	...
	asm volatile("int %1\n"
  80047c:	be 00 00 00 00       	mov    $0x0,%esi
  800481:	b8 0c 00 00 00       	mov    $0xc,%eax
  800486:	8b 4d 0c             	mov    0xc(%ebp),%ecx
  800489:	8b 55 08             	mov    0x8(%ebp),%edx
  80048c:	8b 5d 10             	mov    0x10(%ebp),%ebx
  80048f:	8b 7d 14             	mov    0x14(%ebp),%edi
  800492:	cd 30                	int    $0x30
...
sys_ipc_try_send(envid_t envid, uint32_t value, void *srcva, int perm)
{
  ...
  800494:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  800497:	8b 75 f8             	mov    -0x8(%ebp),%esi
  80049a:	8b 7d fc             	mov    -0x4(%ebp),%edi
  80049d:	89 ec                	mov    %ebp,%esp
  80049f:	5d                   	pop    %ebp
  8004a0:	c3                   	ret    

008004a1 <sys_ipc_recv>:
...
sys_ipc_recv(void *dstva)
{
  ...
  8004b0:	b8 01 00 00 00       	mov    $0x1,%eax
  8004b5:	0f a2                	cpuid  
  8004b7:	89 d6                	mov    %edx,%esi
	//
	// The last clause tells the assembler that this can
	// potentially change the condition codes and arbitrary
	// memory locations.
  ...
  8004d0:	7e 28                	jle    8004fa <sys_ipc_recv+0x59>
		panic("syscall %d returned %d (> 0)", num, ret);
  8004d2:	89 44 24 10          	mov    %eax,0x10(%esp)
  8004d6:	c7 44 24 0c 0d 00 00 	movl   $0xd,0xc(%esp)
  8004dd:	00 
  8004de:	c7 44 24 08 8a 1c 80 	movl   $0x801c8a,0x8(%esp)
  8004e5:	00 
  8004e6:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  8004ed:	00 
  8004ee:	c7 04 24 a7 1c 80 00 	movl   $0x801ca7,(%esp)
  8004f5:	e8 16 08 00 00       	call   800d10 <_panic>
...
sys_ipc_recv(void *dstva)
{
  ...
  8004fa:	8b 5d f4             	mov    -0xc(%ebp),%ebx
  8004fd:	8b 75 f8             	mov    -0x8(%ebp),%esi
  800500:	8b 7d fc             	mov    -0x4(%ebp),%edi
  800503:	89 ec                	mov    %ebp,%esp
  800505:	5d                   	pop    %ebp
  800506:	c3                   	ret    
...
fd_close(struct Fd *fd, bool must_exist)
{
  ...
  8006ce:	e8 f5 fb ff ff       	call   8002c8 <sys_page_unmap>
	return r;
}
...
dup(int oldfdnum, int newfdnum)
{
  ...
  8007d7:	e8 85 fa ff ff       	call   800261 <sys_page_map>
  ...
  800812:	e8 4a fa ff ff       	call   800261 <sys_page_map>
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800d21:	e8 61 f4 ff ff       	call   800187 <sys_getenvid>
...
putch(int ch, struct printbuf *b)
{
  ...
  800d95:	e8 16 f3 ff ff       	call   8000b0 <sys_cputs>
		b->idx = 0;
...
vcprintf(const char *fmt, va_list ap)
{
  ...
  800dfe:	e8 ad f2 ff ff       	call   8000b0 <sys_cputs>
...
ipc_recv(envid_t *from_env_store, void *pg, int *perm_store)
{
  ...
  8018ab:	e8 f1 eb ff ff       	call   8004a1 <sys_ipc_recv>
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801926:	e8 e5 f3 ff ff       	call   800d10 <_panic>
		sys_yield();
  80192b:	e8 90 e8 ff ff       	call   8001c0 <sys_yield>
	// LAB 4: Your code here.
	int r;
  ...
  801942:	e8 1d eb ff ff       	call   800464 <sys_ipc_try_send>

	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80025c:	0f be 80 d1 1c 80 00 	movsbl 0x801cd1(%eax),%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800387:	ff 24 85 20 1e 80 00 	jmp    *0x801e20(,%eax,4)
		case '6':
		case '7':
		case '8':
		case '9':
  ...
  800478:	c7 44 24 08 f2 1c 80 	movl   $0x801cf2,0x8(%esp)
  80047f:	00 
  ...
  8004aa:	b8 e2 1c 80 00       	mov    $0x801ce2,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800c8d:	00 
  800c8e:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800c95:	00 
  800c96:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800c9d:	00 
  800c9e:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800d67:	00 
  800d68:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800d6f:	00 
  800d70:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800d77:	00 
  800d78:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800dce:	00 
  800dcf:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800dd6:	00 
  800dd7:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800dde:	00 
  800ddf:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800e35:	00 
  800e36:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800e3d:	00 
  800e3e:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800e45:	00 
  800e46:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800e9c:	00 
  800e9d:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800ea4:	00 
  800ea5:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800eac:	00 
  800ead:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800f03:	00 
  800f04:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800f0b:	00 
  800f0c:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800f13:	00 
  800f14:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800f6a:	00 
  800f6b:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  800f72:	00 
  800f73:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  800f7a:	00 
  800f7b:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
sys_ipc_recv(void *dstva)
{
  ...
  80100d:	00 
  80100e:	c7 44 24 08 df 1f 80 	movl   $0x801fdf,0x8(%esp)
  801015:	00 
  801016:	c7 44 24 04 58 00 00 	movl   $0x58,0x4(%esp)
  80101d:	00 
  80101e:	c7 04 24 fc 1f 80 00 	movl   $0x801ffc,(%esp)
...
dev_lookup(int dev_id, struct Dev **dev)
{
  ...
  801167:	c7 04 24 0c 20 80 00 	movl   $0x80200c,(%esp)
...
read(int fdnum, void *buf, size_t n)
{
  ...
  8013d8:	c7 04 24 4d 20 80 00 	movl   $0x80204d,(%esp)
...
write(int fdnum, const void *buf, size_t n)
{
  ...
  8014ba:	c7 04 24 69 20 80 00 	movl   $0x802069,(%esp)
...
ftruncate(int fdnum, off_t newsize)
{
  ...
  801571:	c7 04 24 2c 20 80 00 	movl   $0x80202c,(%esp)
...
devfile_write(struct Fd *fd, const void *buf, size_t n)
{
  ...
  801781:	83 ec 18             	sub    $0x18,%esp
	...
	panic("devfile_write not implemented");
  801784:	c7 44 24 08 86 20 80 	movl   $0x802086,0x8(%esp)
  80178b:	00 
  80178c:	c7 44 24 04 77 00 00 	movl   $0x77,0x4(%esp)
  801793:	00 
  801794:	c7 04 24 a4 20 80 00 	movl   $0x8020a4,(%esp)
...
devfile_read(struct Fd *fd, void *buf, size_t n)
{
  ...
  8017a6:	c7 44 24 08 af 20 80 	movl   $0x8020af,0x8(%esp)
  8017ad:	00 
  8017ae:	c7 44 24 04 67 00 00 	movl   $0x67,0x4(%esp)
  8017b5:	00 
  8017b6:	c7 04 24 a4 20 80 00 	movl   $0x8020a4,(%esp)
...
open(const char *path, int mode)
{
  ...
  8017c8:	c7 44 24 08 cc 20 80 	movl   $0x8020cc,0x8(%esp)
  8017cf:	00 
  8017d0:	c7 44 24 04 48 00 00 	movl   $0x48,0x4(%esp)
  8017d7:	00 
  8017d8:	c7 04 24 a4 20 80 00 	movl   $0x8020a4,(%esp)
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80186c:	c7 04 24 e4 20 80 00 	movl   $0x8020e4,(%esp)
  ...
  801882:	e8 7b e8 ff ff       	call   800102 <vcprintf>
	cprintf("\n");
  801887:	c7 04 24 1d 21 80 00 	movl   $0x80211d,(%esp)
...
ipc_send(envid_t to_env, uint32_t val, void *pg, int perm)
{
  ...
  801917:	c7 44 24 08 08 21 80 	movl   $0x802108,0x8(%esp)
  80191e:	00 
  80191f:	c7 44 24 04 51 00 00 	movl   $0x51,0x4(%esp)
  801926:	00 
  801927:	c7 04 24 1f 21 80 00 	movl   $0x80211f,(%esp)
